...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['story'])) {
    ...
    if ($arquivo['error'] === UPLOAD_ERR_OK) {
        ...
        $extensoesPermitidas = ['jpg', 'jpeg', 'png', 'gif', 'mp4', 'mov', 'avi'];

        if (!in_array($extensao, $extensoesPermitidas)) {
            $mensagem = "Tipo de arquivo não permitido. Por favor, envie uma imagem ou vídeo.";
        } else {
...
<body>
  ...
  <div class="content"> 
    <form method="POST" enctype="multipart/form-data">
      ...
      <input type="file" name="story" accept="image/*,video/*" required><br>
